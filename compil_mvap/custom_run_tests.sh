...
#PREF_COR="${PREF_COR:~/Documents/L3/lang/dm/BMs}"
LANG=en_US.utf8
PREF_COR=~/Documents/L3/lang/dm/BMs
...
# mon chemain MVàP
MVAP_JAR="${MVAP_JAR:-/usr/share/tp-compil-autocor/MVaP.jar}"
...
tmpdir="Custom_Compil-"`date +%m-%d-%H:%M`
mkdir $tmpdir
cp $* $tmpdir
cd $tmpdir
